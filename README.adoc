...
Based on the functionalities discussed above, the features required in the `server.xml` are [hotspot=webSocket file=0]`websocket-2.0` and [hotspot=jsonB file=0]`jsonb-2.0`.
